...
def buildInputsText() -> str:
    ...
    return 'Опишите ваш заказ настолько подробно, насколько это возможно. Это нужно, чтобы скинмейкер имел понимание, '+ \
            'что вам нужно, и чтобы результат оправдал все ваши ожидания.\n\n' + \
